- [Stream Architecture](#stream-architecture)
  - [What does Cribl Stream do?](#what-does-cribl-stream-do)
  - [Deployment Modes: Single vs. Distributed](#deployment-modes-single-vs-distributed)
  - [Worker Groups](#worker-groups)
  - [Leader Node](#leader-node)
  - [Cribl.Cloud](#criblcloud)
  - [Remember...](#remember)
- [Stream Architecture: Cribl Stream Installation Guide](#stream-architecture-cribl-stream-installation-guide)
  - [Pre-Installation Prep](#pre-installation-prep)
  - [Security and Licensing](#security-and-licensing)
  - [Port Requirements](#port-requirements)
  - [Git Version Requirement (Distributed Mode Only) for Leader Node](#git-version-requirement-distributed-mode-only-for-leader-node)
  - [Installation Steps](#installation-steps)
  - [Logging In For The First Time](#logging-in-for-the-first-time)
  - [Adding Worker Nodes (Leader Mode Only)](#adding-worker-nodes-leader-mode-only)
- [Remember...](#remember-1)
- [Stream Projects](#stream-projects)
- [Stream Projects: Isolated Workspaces for Teams and Users](#stream-projects-isolated-workspaces-for-teams-and-users)
  - [Key Components of Stream Projects](#key-components-of-stream-projects)
  - [Project Access Levels](#project-access-levels)
- [Remember...](#remember-2)
- [Stream Fundamentals: Sources, Destinations \& Collectors](#stream-fundamentals-sources-destinations--collectors)
  - [Sources](#sources)
  - [Destinations](#destinations)
  - [Collectors](#collectors)
  - [Output Routers](#output-routers)
  - [Data Delivery \& Backpressure](#data-delivery--backpressure)
  - [Remember...](#remember-3)
- [Stream Fundamentals: Routes \& QuickConnect](#stream-fundamentals-routes--quickconnect)
  - [Routing Methods](#routing-methods)
  - [Understanding Routes](#understanding-routes)
  - [Route Creation \& Associations](#route-creation--associations)
  - [Route Strategies \& Efficiency](#route-strategies--efficiency)
- [Stream Fundamentals: Pipelines, Functions \& Packs](#stream-fundamentals-pipelines-functions--packs)
  - [Imagine Cribl Stream as a Processing Factory](#imagine-cribl-stream-as-a-processing-factory)
  - [Understanding Pipelines: The Assembly Line](#understanding-pipelines-the-assembly-line)
  - [Functions](#functions)
  - [Packs](#packs)
  - [Remember...](#remember-4)
- [Stream Fundamentals: Replay Basics](#stream-fundamentals-replay-basics)
  - [What is Replay \& Why is it Valuable?](#what-is-replay--why-is-it-valuable)
  - [The Replay Process: Step-by-Step Walkthrough](#the-replay-process-step-by-step-walkthrough)
  - [Best Practices for Effective Replay](#best-practices-for-effective-replay)
  - [Remember...](#remember-5)
- [Stream Fundamentals: Events \& Processing Order](#stream-fundamentals-events--processing-order)
  - [Events: The Building Blocks of Data Processing](#events-the-building-blocks-of-data-processing)
  - [Event Processing Order: Step-by-Step](#event-processing-order-step-by-step)
  - [Understanding Internal Fields \& Timestamps](#understanding-internal-fields--timestamps)
  - [Remember...](#remember-6)
- [Stream Fundamentals: Filters \& Value Expressions](#stream-fundamentals-filters--value-expressions)
  - [JavaScript: A Foundational Language](#javascript-a-foundational-language)
  - [JavaScript in Cribl Stream](#javascript-in-cribl-stream)
  - [Filters: Streamlining Data Flows](#filters-streamlining-data-flows)
  - [Value Expressions: Assigning \& Extracting Data](#value-expressions-assigning--extracting-data)
  - [Remember...](#remember-7)
